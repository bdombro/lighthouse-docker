...
exports.waitForTruthy = exports.waitFor = exports.delay = void 0;
const debugLog = (message) => null; // console.debug;
/**
...
const waitForPass = async (callback, options) => {
    ...
    while (!res) {
        ...
        if (timeUntilInterval > 0) {
            ...
            await exports.delay(timeUntilInterval);
        }
    }
    return res;
};
exports.waitFor = Object.assign(waitForPass, { NotReadyException });
/**
 ...
 *
 */
const waitForTruthy = async (callback, options = {}) => {
